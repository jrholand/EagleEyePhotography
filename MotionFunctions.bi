...
FUNCTION SetAnalogVelocity(velocity,Immediate )
  DIM tempCtrlWord                                                                          
   tempCtrlWord = CiACmdEnableOperation      
   SETOBJ Controlword = tempCtrlWord
   SETOBJ TargetVelocity = velocity
...
FUNCTION SetProfileVelocity(velocity,Immediate )
  DIM tempCtrlWord                                                                          
   tempCtrlWord = CiACmdEnableOperation      
   SETOBJ Controlword = tempCtrlWord
   SETOBJ ProfileVelocity = velocity         
